    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative -mt-12 bg-gradient-to-br from-blue-500 to-sky-300 lg:h-2/3 lg:w-full ">
        <div className="  flex items-center justify-center">
          <div className="relative -left-16 top-24 lg:-left-64 lg:top-28">
            <svg
              ...
              version="1.0"
              viewBox="0 0 867 254"
              className="mr-3 h-12 w-auto fill-white md:h-16  "
            >
        ...
        <svg
          ...
          className="z-20 fill-white dark:fill-zinc-900 lg:hidden lg:w-[50%]"
        >
          <path
        ...
        <svg
          ...
          preserveAspectRatio="none"
          className="hidden w-[150%] fill-white dark:fill-zinc-900 lg:block"
        >
          <path
            d="M0 458L37.5 435C75 412 150 366 225 363.8C300 361.7 375 403.3 450 393.7C525 384 600 323 675 274.3C750 225.7 825 189.3 862.5 171.2L900 153L900 601L862.5 601C825 601 750 601 675 601C600 601 525 601 450 601C375 601 300 601 225 601C150 601 75 601 37.5 601L0 601Z"
            strokeLinecap="round"
