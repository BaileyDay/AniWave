...
const Subscribe = () => {
  ...
  return (
    <>
      ...
      <section className="rounded-xl bg-slate-100 dark:bg-zinc-800">
            ...
            <form action="#" onSubmit={handleFormSubmit}>
              <div className="mx-auto mb-3 max-w-screen-sm items-center space-y-4 sm:flex sm:space-y-0">
                <div className="relative w-full">
                  ...
                  <input
                    className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-3 pl-10 text-sm text-gray-900 focus:border-sky-500 focus:ring-sky-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-sky-500 dark:focus:ring-sky-500 sm:rounded-none sm:rounded-l-lg"
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full cursor-pointer rounded-lg border border-sky-400 bg-sky-500 px-5 py-3 text-center text-sm font-medium text-white hover:bg-sky-600  focus:ring-0 dark:bg-sky-600  dark:hover:bg-sky-700 sm:rounded-none sm:rounded-r-lg"
                  >
                    Subscribe
                  </button>
                </div>
