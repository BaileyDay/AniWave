        ...
        <div className="container mx-auto lg:flex lg:max-w-[72rem]">
          <div className="space-y-7  lg:mx-0 lg:w-1/2 lg:space-y-8">
            <div className="space-y-6 lg:space-y-10">
              ...
              <form className="w-full lg:relative" onSubmit={handleFormSubmit}>
                ...
                />
                <div className="mt-4 flex items-center  lg:absolute lg:inset-y-0 lg:right-0 lg:mt-0 lg:p-[6px] ">
                  <button
                    as="button"
                    type="submit"
          ...
          <div className="relative hidden w-1/2 lg:block">
            <svg
              ...
              width="100%"
              id="blobSvg"
              className="absolute -bottom-96 -right-96 z-0 h-auto w-[175%]"
            >
              <defs>
                <linearGradient
                  id="gradient"
                ...
                >
                  <stop
                    offset="0%"
                    style={{ stopColor: '#68ddfd', stopOpacity: 1 }}
                  />
                  <stop
                    offset="100%"
