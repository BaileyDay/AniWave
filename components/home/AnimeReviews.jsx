...
const AnimeReviews = () => {
  return (
    <div className="container mx-auto px-4 py-12 lg:max-w-[90rem]">
      ...
      <button class="dark:focus:ring-sky-8 group relative mb-2 mr-2 mt-4 inline-flex  w-full items-center  justify-center overflow-hidden rounded-lg bg-gradient-to-br from-sky-500 to-blue-500 p-0.5 text-sm font-medium text-slate-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-cyan-200 group-hover:from-cyan-500 group-hover:to-blue-500 dark:text-white lg:w-auto">
