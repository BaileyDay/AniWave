  ...
  return (
    <>
      ...
      >
        ...
        <div className="dark:bg-gray-800 dark:text-gray-400  sticky top-40 mb-6  rounded-lg  border border-slate-5 bg-slate-1 p-5 font-medium text-slate-12 shadow dark:border-slate-9">
          ...
          <div className="flex items-center py-2">
            <ul>
              {sectionTitles.map(({ id, title }) => (
                <li key={id} className="p-2 font-bold">
                  <a href={`#${id}`}>{title}</a>
                </li>
              ))}
            </ul>
